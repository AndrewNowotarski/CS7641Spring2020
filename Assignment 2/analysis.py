...
def run_analysis(estimator, X_train, Y_train, X_test, Y_test, dataset, modelType, analysisRound, validationXLabel, param, param_values, x_labels = []):
    ...
    plotting.plot_validation_curve(estimator, X_train, Y_train.ravel(), dataset, modelType, analysisRound, validationXLabel, param, param_values, x_labels)